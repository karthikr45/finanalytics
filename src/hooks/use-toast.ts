...
// Lightweight toast store, modeled on the shadcn/ui `use-toast` pattern —
// a module-level reducer so any component can call `toast()` without a
// context provider wrapping the tree (only <Toaster/> needs to be mounted).
